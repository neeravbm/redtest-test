...
namespace RedTest\tests\test\crud\Fields\TermRefAutoCompleteMulti1;
...
class AuthenticatedUserTest extends AuthenticatedUser {
  ...
  protected static $field_name = 'field_term_ref_autocomp_multi_1';
  ...
  protected static $valueMultiple = array('term 2', 'term 3');

  protected static $expectedValueMultiple = array('term 2', 'term 3');
  ...
  public function testValueMultipleSubmission() {
    ...
    static::$valueMultiple = static::$expectedValueMultiple = array(
  ...
  public static function tearDownAfterClass() {
    ...
    // well.
    $terms = taxonomy_get_term_by_name(static::$valueOne, 'tags');
    $term = array_shift($terms);
    taxonomy_term_delete($term->tid);

    foreach (static::$valueMultiple as $name) {
